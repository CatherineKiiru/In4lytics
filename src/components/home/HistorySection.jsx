...
const HistorySection = () => {
  return (
    <>
      <section className="bg-lightGreen md:absolute md:w-full mx-auto">
        <div className="md:max-w-[1580px] md:mx-auto md:items-center">
          ...
          <div className="bg-oliveGreen p-6 space-y-4 md:relative md:float-right md:rounded-xl md:z-10 md:top-[-10rem] md:max-w-lg md:mr-24">
